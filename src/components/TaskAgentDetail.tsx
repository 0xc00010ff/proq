              ...
              <ReactMarkdown
                ...
                components={{
                  ...
                  code: ({ children, className: cn }) => {
                    ...
                    if (isBlock) {
                      return <code className={`${cn} block bg-bronze-200/60 dark:bg-zinc-900 rounded px-3 py-2 text-xs font-mono text-bronze-800 dark:text-zinc-300 overflow-x-auto my-2`}>{children}</code>;
                    }
