  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-8">
      ...
      >
        ...
        {/* Content — description scrolls when modal hits max height */}
        <div className="p-6 pt-5 shrink-0">
          {/* Mode selector */}
          ...
          <input
            ...
            className="w-full bg-transparent text-xl font-semibold text-bronze-900 dark:text-zinc-100 placeholder-bronze-500 dark:placeholder-zinc-700 focus:outline-none pr-8"
        ...
        {attachments.length > 0 && (
          <div className="px-6 py-3 flex flex-wrap gap-2 shrink-0">
            {attachments.map((att) => {
