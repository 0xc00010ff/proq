    ...
    <div className="my-2">
      <div className="rounded-lg border border-border-default bg-surface-topbar overflow-hidden">
        ...
        {planContent ? (
          <>
            ...
            {expanded && (
              <div className="border-t border-border-subtle/60 max-h-[36rem] overflow-y-auto px-3">
      ...
      {planContent && (
        <Modal isOpen={modalOpen} onClose={() => setModalOpen(false)} className="max-w-5xl w-full mx-4 flex flex-col max-h-[80vh]">
          <div className="flex items-center gap-2 px-5 py-3 border-b border-border-default shrink-0">
