  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button
          className={cn(
            "w-full flex items-center justify-between bg-surface-modal border border-border-strong/50 rounded-md px-3 py-2 text-sm text-text-primary outline-none hover:border-border-strong hover:bg-surface-hover/40 transition-colors",
            className
          )}
        >
