...
export const SHORTCUTS: ShortcutDef[] = [
  ...
  { id: 'tab-1',        key: '1',          meta: true,               scope: 'global', label: 'Toggle upper-left panel' },
  { id: 'tab-2',        key: '2',          meta: true,               scope: 'global', label: 'Toggle lower panel' },
  { id: 'tab-3',        key: '3',          meta: true,               scope: 'global', label: 'Toggle upper-right panel' },
